...
> **Source**: [fsd.how](https://fsd.how) | Strictness can be adjusted based on project scale and team context.
...
[Steiger](https://github.com/feature-sliced/steiger) is the official FSD linter. Key rules:
