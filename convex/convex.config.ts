...
// RESEND_FROM_ADDRESS and RESEND_TEST_MODE are read by our own code
...
// RESEND_TEST_MODE gates whether sends actually go out for real, since
// there's no separate dev deployment to default that behavior from.
const app = defineApp({
  env: {
