...
export type DataSource =
  ...
  // direction/group/sourceParam aren't used by the frontend today (only
  ...
  // A Select whose options are files (see convex/files) rather than
  // selectOptions rows — the files-table counterpart to "dynamic".
  | { kind: "fileOptions"; group: string };
