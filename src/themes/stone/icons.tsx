...
// `astryx theme build` (see package.json) loads this file with jiti's
// default classic JSX transform, which needs `React` in scope even though
// the app itself builds with the automatic runtime and never reads it.
void React;
