...
// mean the box's two-line truncation would cut off real content. Content-fit
// based rather than tied to a specific variant, since any variant can carry
// either a short or a long message.
